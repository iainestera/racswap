...
import BannerPng from './components/banner.png';
          ...
          {[isXs, isSm].some(Boolean) ? (
            <>
              <Text mb="20px" style={{ whiteSpace: 'nowrap', minWidth: '230px' }} color="">
                PRICE： ${cakePriceBusd.isNaN() ? '0' : cakePriceBusd.toFixed(2)}
              </Text>
              <Text mb="20px" style={{ whiteSpace: 'nowrap', minWidth: '230px' }} color="">
                Total：{cap}
              </Text>
              <Text mb="20px" style={{ whiteSpace: 'nowrap', minWidth: '230px' }} color="">
                Circulation：{cakeSupply}
              </Text>

              <Text mb="20px" style={{ whiteSpace: 'nowrap', minWidth: '230px' }} color="">
                Burnt：{burnedBalance.toFixed()}
              </Text>
              <Text mb="20px" style={{ whiteSpace: 'nowrap', minWidth: '230px' }} color="">
                Market CAP： ${mcapString}
              </Text>
            </>
          ) : (
            <>
