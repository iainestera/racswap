      ...
      <AutoColumn gap="md">
        <div style={{ padding: '0px 20px' }}>
          <RowBetween align="center">
            ...
            <Text fontSize="32px" color="#f6941d">
            ...
            {!showDetailed && (
              <BorderCard>
                <Flex mb="26px" alignItems="flex-end">
                  <Text fontSize="32px" color="#f6941d" bold style={{ lineHeight: 1 }}>
                    {formattedAmounts[Field.LIQUIDITY_PERCENT]}%
                  </Text>
                  <Text color="#f6941d" fontSize="12px" marginLeft="10px">
                    {t('Amount')}
                  </Text>
                </Flex>
                ...
                <Flex flexWrap="wrap" justifyContent="space-evenly">
                  <Button
                    style={{
                      color: innerLiquidityPercentage === 25 ? 'white' : '#f6941d',
                      background: innerLiquidityPercentage === 25 ? '#f6941d' : '#1F252A',
                      borderRadius: '12px',
                    }}
                    variant="tertiary"
                    scale="sm"
                  ...
                  <Button
                    style={{
                      color: innerLiquidityPercentage === 50 ? 'white' : '#f6941d',
                      background: innerLiquidityPercentage === 50 ? '#f6941d' : '#1F252A',
                      borderRadius: '12px',
                    }}
                    variant="tertiary"
                    scale="sm"
                  ...
                  <Button
                    style={{
                      color: innerLiquidityPercentage === 75 ? 'white' : '#f6941d',
                      background: innerLiquidityPercentage === 75 ? '#f6941d' : '#1F252A',
                      borderRadius: '12px',
                    }}
                    variant="tertiary"
                    scale="sm"
                  ...
                  <Button
                    style={{
                      color: innerLiquidityPercentage === 100 ? 'white' : '#f6941d',
                      background: innerLiquidityPercentage === 100 ? '#f6941d' : '#1F252A',
                      borderRadius: '12px',
                    }}
                    variant="tertiary"
                    scale="sm"
