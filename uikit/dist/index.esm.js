...
var templateObject_1$18, templateObject_2$u, templateObject_3$e;
...
var ButtonMenuItem = function (_a) {
    ...
    if (!isActive) {
        return (React.createElement(InactiveButton, __assign({ style: { height: "40px", color: "#9DA6A6" }, forwardedAs: as, variant: variant }, props)));
    }
    return (React.createElement(Button, __assign({ style: { height: "40px", background: "#272E32", color: "white" }, as: as, variant: variant }, props)));
};
...
var BarBackground = styled.div(templateObject_6$1 || (templateObject_6$1 = __makeTemplateObject(["\n  background-color: ", ";\n  height: 10px;\n  border-radius: 5px;\n  position: absolute;\n  top: 11px;\n  left: 2px;\n  right: 1px;\n"], ["\n  background-color: ", ";\n  height: 10px;\n  border-radius: 5px;\n  position: absolute;\n  top: 11px;\n  left: 2px;\n  right: 1px;\n"])), function (_a) {
    ...
    return (disabled ? theme.colors.textDisabled : "#1f252a");
});
...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", backgroundAlt: "#FFFFFF", cardBorder: "##272E32", cardBackground: "#1F252A", primarySecondary: "#238485", contrast: "#191326", dropdown: "#F6F6F6", dropdownDeep: "#EEEEEE", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#9DA6A6", textDisabled: "#BDC2C4", textSubtle: "#9DA6A6", disabled: "#E9EAEB", gradients: {
...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#9DA6A6", background: "#08060B", backgroundDisabled: "#3c3742", backgroundAlt: "#27262c", cardBorder: "#272E32", cardBackground: "#1F252A", primarySecondary: "#238485", contrast: "#FFFFFF", dropdown: "#1E1D20", dropdownDeep: "#100C18", invertedContrast: "#191326", input: "#372F47", inputSecondary: "#262130", primaryDark: "#0098A1", tertiary: "#12171A", text: "#F4EEFF", textDisabled: "#666171", textSubtle: "#9DA6A6", disabled: "#524B63", gradients: {
...
var ModalCloseButton = function (_a) {
    ...
    return (React.createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
        React.createElement(Icon$1s, { color: "#9DA6A6", height: "12px", width: "12px" })));
};
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(ModalContainer, { minWidth: "320px" },
        ...
        React.createElement(ModalBody, { width: ["320px", null, "340px"] },
            React.createElement(WalletWrapper, { py: "24px", maxHeight: "453px", overflowY: "auto" }, displayListConfig.map(function (wallet) { return (React.createElement(Box, { key: wallet.title },
