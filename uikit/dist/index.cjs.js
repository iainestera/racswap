...
var StyledInput$1 = styled__default['default'](Input$1)(templateObject_2$s || (templateObject_2$s = __makeTemplateObject(["\n  background: transparent;\n  border-radius: 0;\n  box-shadow: none;\n  padding-left: 0;\n  padding-right: 0;\n  text-align: right;\n  border: none;\n\n  ::placeholder {\n    color: ", ";\n  }\n\n  &:focus:not(:disabled) {\n    box-shadow: none;\n  }\n"], ["\n  background: transparent;\n  border-radius: 0;\n  box-shadow: none;\n  padding-left: 0;\n  padding-right: 0;\n  text-align: right;\n  border: none;\n\n  ::placeholder {\n    color: ", ";\n  }\n\n  &:focus:not(:disabled) {\n    box-shadow: none;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.textSubtle;
});
...
var ButtonMenuItem = function (_a) {
    ...
    if (!isActive) {
        return (React__default['default'].createElement(InactiveButton, __assign({ style: { height: "40px", color: "#9DA6A6" }, forwardedAs: as, variant: variant }, props)));
    }
    return (React__default['default'].createElement(Button, __assign({ style: { height: "40px", background: "#272E32", color: "white" }, as: as, variant: variant }, props)));
};
...
var ModalCloseButton = function (_a) {
    ...
    return (React__default['default'].createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
        React__default['default'].createElement(Icon$1s, { color: "#9DA6A6", height: "12px", width: "12px" })));
};
...
var ConnectModal = function (_a) {
    ...
    return (React__default['default'].createElement(ModalContainer, { minWidth: "320px" },
        ...
        React__default['default'].createElement(ModalBody, { width: ["320px", null, "340px"] },
            React__default['default'].createElement(WalletWrapper, { py: "24px", maxHeight: "453px", overflowY: "auto" }, displayListConfig.map(function (wallet) { return (React__default['default'].createElement(Box, { key: wallet.title },
